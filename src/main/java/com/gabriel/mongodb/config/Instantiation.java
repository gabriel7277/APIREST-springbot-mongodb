...
import com.gabriel.mongodb.repository.UserRepository;
	...
	public class Instantiation implements CommandLineRunner {
		...
		public void run(String... arg0) throws Exception {
			...
			Post post10 = new Post(null, sdf.parse("22/03/2018"), "Partiu viagem", "Vou viajar para  o Rio de Janeiro.",  gabriel);

			Post post20 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!",  gabriel);
